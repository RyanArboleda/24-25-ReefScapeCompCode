...
public class RobotContainer {
    ...
    private final SlewRateLimiter filterX = new SlewRateLimiter(1.4);
    private final SlewRateLimiter filterY = new SlewRateLimiter(1.4);
    ...
    public RobotContainer() {
        ...
        autoChooser.addOption("Medium Test Auto", new PathPlannerAuto("Medium Test Auto"));
